...
public class SellCombinerTest {
    ...
    public void shouldCombineSellQuantities() throws Exception {
        ...
        assertThat(new SellCombiner().combine(summaryItem1, summaryItem2), is(SummaryItem.sell(300, BigDecimal.TEN)));
    }

    @Test
    public void shouldCombineBuyAndSellQuantities() throws Exception {
        SummaryItem summaryItem1 = SummaryItem.sell(400, BigDecimal.TEN);
        SummaryItem summaryItem2 = SummaryItem.buy(100, BigDecimal.TEN);
        assertThat(new SellCombiner().combine(summaryItem1, summaryItem2), is(SummaryItem.sell(300, BigDecimal.TEN)));
    }
